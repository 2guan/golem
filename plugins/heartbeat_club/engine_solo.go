...
func enrichActionDesc(scene SceneType, text string) string {
	...
	case SceneGym:
		switch clean {
		case "贴身卧推", "卧推", "大重量卧推":
			return "准备冲刺大重量，请求对方站在正上方贴身辅助保护"
		case "借沐浴露", "沐浴露":
			return "更衣室淋浴间水汽蒸腾，带着一身水珠向对方借沐浴露"
		case "检查发力", "摸发力", "发力":
			return "让对方伸手贴在后背背阔肌和胸口上，感受发力紧绷与肌肉充血程度"
		case "递毛巾", "擦汗":
			return "递上温热毛巾顺势靠得很近，替对方擦拭喉结和脖颈上的热汗"
		}
	case SceneBar:
		switch clean {
		case "今夜特调", "调酒", "来杯酒":
			return "递给调酒师一个眼神，让他调一杯能让人彻底放下防备、带有微醺试探意味的独家特调"
		case "推杯换盏", "碰杯", "喝酒":
			return "端起酒杯与调酒师轻轻碰杯，眼神对视，看他喉结吞咽"
		case "装醉倚靠", "装醉", "靠肩膀":
			return "借着三分酒意，将头轻轻歪在对方宽厚结实的肩膀上"
		case "吧台耳语", "耳语", "说悄悄话":
			return "俯身撑在吧台边缘拉近距离，将温热呼吸吐在对方耳畔说了一句轻佻试探"
		}
	case SceneDorm:
		switch clean {
		case "挤一张床", "挤挤", "同床":
			return "借口被窝太冷，钻进了室友的单人床挤在一起"
		case "借穿球衣", "穿球衣", "球衣":
			return "顺手扯下室友换下来的宽松大号球衣套在自己身上"
		case "掰手腕", "较量":
...
func callAISoloInteraction(caller plugin.CallerAbility, s *SoloSession, scene SceneInfo, action string) (string, error) {
	systemPrompt := fmt.Sprintf(`你现在就是微信对面的剧情男主本人。这是一场即时微信面对面聊天对戏，严禁写第三人称小说旁白！
【你的人物设定】：
你是一个成熟、性感、身材微壮饱满的熟男。表面糙汉嘴碎、爱开玩笑，骨子里懂生活懂体贴，极具荷尔蒙性张力与熟男魅力。
...
2. 严禁小说叙事旁白：绝对不要写任何“他看着你”、“大手搭在...”这种旁观者小说叙事！
3. 允许自然的短括号微动作：如果需要配合动作神态，可以直接写在简短的中文括号里（如“（一把扶住你肩膀拉过来）”、“（忍不住低笑了一声，低头看你）”），然后自然接着说话；
4. 语言风格：接地气的熟男老哥口吻，声音微哑低沉，嘴碎逗趣又充满荷尔蒙拉扯，直球又带宠溺；
5. 绝不要任何标题或指引：不要带任何“【画面】”、“【对话】”等标签，不要在文末提示用户该怎么做；
