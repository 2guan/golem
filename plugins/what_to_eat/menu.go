...
var defaultMenu = []Dish{
	// ================= 早餐 / 早午餐 =================
	{
		...
		ChefTip:     "老饕秘籍：香菜必须抓两大把，泼上半勺红油辣椒，先吸两口原汤，再把烧饼在汤里稍微蘸一下，绝了！",
	},
	{
		Name:        "双蛋煎饼果子 + 现磨豆浆",
		Category:    "街头快餐",
		...
		ChefTip:     "老饕秘籍：千万别加什么火腿肠生菜乱七八糟的，就双蛋加双份薄脆！听那一口咔嚓声，比赢了团战还解压。",
	},
	{
		Name:        "皮蛋瘦肉粥 + 广式虾饺皇",
		Category:    "广式茶点",
		...
		ChefTip:     "老饕秘籍：宿醉或昨晚夜宵吃油腻了？来这碗热粥刮刮油，配两滴白胡椒粉，胃瞬间舒服了。",
	},
	{
		Name:        "武汉热干面 + 冰米酒蛋花汤",
		Category:    "面食",
		...
		ChefTip:     "老饕秘籍：趁热八秒内必须拌匀！每一根面条都要裹满酱，吃完再灌一大口冰蛋酒，甘甜清凉解大腻。",
	},
	...
	// ================= 午餐 / 工作日快餐 =================
	{
		...
		ChefTip:     "老饕秘籍：跟师傅喊‘二细，辣子多些！’，点一份切片牛肉直接倒进汤里泡着，就着剥皮生蒜，这顿午饭才算有灵魂。",
	},
	{
		Name:        "老北京小碗干炸炸酱面",
		Category:    "面食",
		...
		ChefTip:     "老饕秘籍：别一上来全倒进去！先挖两勺酱，黄瓜丝心儿里美豆芽拌匀，就一口生紫皮蒜，从小吃到大吃不腻。",
	},
	{
		Name:        "隆江猪脚饭（加卤蛋肉卷）",
		Category:    "盖饭便当",
		...
		ChefTip:     "老饕秘籍：老板要是手抖少给浇卤汁，记得厚着脸皮多要一勺！把酸菜和米饭搅拌在一起，肥瘦相间一口闷，人间值得。",
	},
	{
		Name:        "川香回锅肉盖浇饭",
		Category:    "盖饭便当",
		...
		ChefTip:     "老饕秘籍：青蒜苗炒到微微断生带甜味是精髓，肥肉部分的油全煸出来了，卷着蒜苗能扒下两碗大米饭。",
	},
	{
		...
		ChefTip:     "老饕秘籍：酸梅酱多蘸点！鹅油渗进热米饭里之后，每一口米饭都香得让人跺脚。",
	},
	{
		Name:        "新疆重辣炒米粉 + 烤包子",
		Category:    "面食小吃",
		...
		ChefTip:     "老饕秘籍：不能吃辣的自觉点微辣！吃完赶紧备一盒冰酸奶，否则下午打游戏键盘上全是汗珠子。",
	},
	{
		Name:        "重庆豌杂小面（干溜干拌）",
		Category:    "面食",
		...
		ChefTip:     "老饕秘籍：必须选干溜！不要汤！拌匀后让每根细面都裹上沙沙的烂豌豆泥，麻辣鲜香直冲天灵盖。",
	},
	{
		...
		ChefTip:     "老饕秘籍：把金针菇和吸饱汤汁的土豆块捣碎在白米饭里，连汤带肉一勺舀下去，性价比之王不是吹的。",
	},
	...
	// ================= 减脂 / 清淡 / 养生 =================
	{
		...
		ChefTip:     "老饕秘籍：别选热量炸弹蛋黄酱！淋半勺日式油醋汁或低钠酱油芥末，健康又不委屈嘴巴。",
	},
	{
		Name:        "酸汤金汤巴沙鱼 + 粗粮饭",
		Category:    "家常快餐",
		...
		ChefTip:     "老饕秘籍：鱼肉纯蛋白质几乎没脂肪，酸辣汤汁特别提神醒脑，下午不容易犯困！",
	},
	{
		Name:        "全麦金枪鱼三明治 + 冰美式",
		Category:    "轻食减脂",
		...
		ChefTip:     "老饕秘籍：赶时间或者想控糖减肥时首选，冰美式一大口下去，水肿全消，战斗力拉满。",
	},
	...
	// ================= 摸鱼下午茶 / 续命水 =================
	{
		...
		ChefTip:     "老饕秘籍：下午三四点脑子发懵、嘴巴发干？整一杯少糖大冰，猛吸一口直通脑门，精神抖擞。",
	},
	{
		Name:        "生椰拿铁 + 海盐芝士贝果",
		Category:    "下午茶饮",
		...
		ChefTip:     "老饕秘籍：摸鱼三点半的黄金搭档！贝果一定要让店员加热烤脆皮，咬一口外脆里韧嚼劲十足。",
	},

	// ================= 晚餐 / 聚餐 / 锅物 =================
	{
		Name:        "潮汕鲜牛肉火锅（吊龙 + 匙柄 + 熟牛丸）",
		Category:    "火锅聚餐",
		MealTimes:   []MealTime{MealDinner},
		Tags:        []string{"火锅", "聚餐", "牛肉", "高蛋白", "清淡"},
		Calories:    "⭐⭐⭐ (纯牛肉高蛋白，只要不喝麻酱就不慌)",
		Description: "牛骨清汤沸水翻滚，鲜切吊龙肉伴着细微雪花，八上八下九秒即捞，搭配手打爆汁牛丸与炸腐竹。",
		ChefTip:     "老饕秘籍：沙茶酱调一勺，兑半勺芹菜粒和普宁豆酱！咬那手打牛丸小心点，真会滋一身肉汁。",
	},
	{
		...
		ChefTip:     "老饕秘籍：糖蒜必须剥三瓣搁手边！羊肉变白立刻捞，蘸透麻酱，嚼一口肉嚼一口糖蒜，神仙都不换。",
	},
	{
		...
		ChefTip:     "老饕秘籍：香油蒜泥碟是保命护胃的，千万别加麻酱！毛肚下中心沸水格子，数七下脆生生起锅，过香油一口吞！",
	},
	{
		...
		ChefTip:     "老饕秘籍：锅底那把吸饱鹅油高汤的东北土豆宽粉才是真神！铲下一块焦脆锅巴饼蘸着浓汁吃，香迷糊了。",
	},
	{
		...
		ChefTip:     "老饕秘籍：把擂辣椒皮蛋直接扣在大米饭正中央，挖一勺牛肉连油带肉拌开，辣得胃里暖烘烘，米饭根本不够吃。",
	},
	...
	// ================= 罪恶夜宵 / 疗愈酒肆 =================
	{
		...
		ChefTip:     "老饕秘籍：脑花一定要趁热拿勺子挖，入口即化！再闷一大口冰凉挂壁的精酿，什么烦心事儿都去他大爷的。",
	},
	{
		...
		ChefTip:     "老饕秘籍：炸蛋必须在汤底最深处浸泡三分钟！捞出来沉甸甸咬开爆汁，鸭掌一嗦脱骨，深夜吃这个简直犯罪。",
	},
	{
		...
		ChefTip:     "老饕秘籍：虾吃完了千万别让服务员收盘子！扔两饼泡软的华丰三鲜伊面倒进汤里拌匀，那一碗面比龙虾肉还抢手。",
	},
	{
		...
		ChefTip:     "老饕秘籍：跟大爷喊‘多放醋少放辣，陈醋顺着边浇出焦香味！’，热乎乎扎上一块，瞬间梦回大学宿舍通宵打游戏的时光。",
	},
}
